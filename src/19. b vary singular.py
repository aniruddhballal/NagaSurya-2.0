...
def calcalm(b_func, lmax, num_points_theta, num_points_phi, carrington_map_number, check):
    ...
    values_folder = ""
    if check == 1:
        values_folder = "alm_values_split_temp"
    else:
        values_folder = "predicted_alm_values_temp"
...
target_cr_numbers = set(range(2097, 2119)) | set(range(2128, 2291))  # 2097-2118 and 2128-2290
...
# following line leftshifts the predicted values
# b_avg_recons_pred_values = b_avg_recons_pred_values[1:] + [None]  # Shift left, append None
...
# Set y-axis limits for both axes from 0 to 17
ax1.set_ylim(0, 17)
ax2.set_ylim(0, 17)

# Set y-ticks explicitly from 0 to 17
...
plot_path = os.path.join(plots_dir, f"overall.png")
